...
const Interview = () => {
  ...
  const safeReport = {
    ...
    matchScore: typeof report.matchScore === "number" ? report.matchScore : 0,
              ...
              <div className="q-list">
                {safeReport.technicalQuestions.length > 0 ? (
                  ...
                  <p className="empty-state">
                    The report does not include technical questions yet.
                  </p>
                )}
              </div>
            </section>
            ...
            <section>
              ...
              <div className="q-list">
                {safeReport.behavioralQuestions.length > 0 ? (
                  ...
                  <p className="empty-state">
                    The report does not include behavioral questions yet.
                  </p>
                )}
              </div>
            </section>
            ...
            <section>
              ...
              <div className="roadmap-list">
                {safeReport.preparationPlan.length > 0 ? (
                  ...
                  <p className="empty-state">
                    No preparation roadmap was generated yet.
                  </p>
                )}
              </div>
            </section>
          ...
          <div className="skill-gaps">
            ...
            <div className="skill-gaps__list">
              {safeReport.skillGaps.length > 0 ? (
                ...
                <p className="empty-state">No skill gaps were detected.</p>
              )}
            </div>
          </div>
        </aside>
